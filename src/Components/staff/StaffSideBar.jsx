    ...
    >
        ...
        {isExpanded && (
          <div className="flex-grow">
            <svg
              ...
              stroke="currentColor"
            ></svg>
            <span className="text-lg text-blue-800 font-semibold">Staff Dashboard</span>
          </div>
        )}
      </div>
      ...
      <nav>
        ...
        >
          ...
          {!isExpanded ? null : (
            <>
              <span class="flex-1 ml-3 whitespace-nowrap text-black">Manage Tours</span>
        ...
        >
          <svg
            ...
            stroke="currentColor"
            viewBox="0 0 24 24"
          > <IoMdChatboxes size = "20"/> </svg>
          {!isExpanded ? null : <span class="ml-3 text-black">Chat</span>}
        ...
        >
          ...
          {!isExpanded ? null : <span class="ml-3 text-black">Payment</span>}
