...
const GuidePayment = () => {
            ...
            <div>
                ...
                {trackPoints.map((point, index) => (
                    <div key={index} className="flex justify-between mb-4">
                        ...
                        {(selectedTrip.Status !== 'End' && selectedTrip.Status !== 'Close') &&
                            <div>
    ...
    const handlePay = async () => {
        try {
            const response = await instance.put('/trip/updateTripStatus', {
                TripID: selectedTrip.TripID,
                Status: 'Close'
            });
            const response1 = await instance.put('/trip/updateTripdistancepayment', {
                TripID: selectedTrip.TripID,
            ...
            // Close the modal or update the UI as needed after payment
        } catch (error) {
